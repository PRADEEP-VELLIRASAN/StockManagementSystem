...
const YarnInventory = () => {
  ...
  const fetchYarns = async () => {
    setIsLoading(true);
    try {
      const res = await axios.get("https://stockmanagementsystem-d5kp.onrender.com/api/yarns");
      setYarns(res.data);
      setError("");
    } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        await axios.put(`https://stockmanagementsystem-d5kp.onrender.com/api/yarns/${editingId}`, {
          yarnType,
        ...
        // Add new yarn
        await axios.post("https://stockmanagementsystem-d5kp.onrender.com/api/yarns", {
          yarnType,
          quantity: Number(quantity),
          supplier
        });
  ...
  const handleDelete = async (id) => {
    ...
    try {
      setIsLoading(true);
      await axios.delete(`https://stockmanagementsystem-d5kp.onrender.com/api/yarns/${id}`);
